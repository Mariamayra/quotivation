...
function App() {
  ...
  const [favoriteQuotes, setFavoriteQuotes] = useState(JSON.parse(window.localStorage.getItem("favorite quotes")) || []);
  ...
  const quotesUrl =
    ...
    const addToFavorites = (quoteId) => {
      ...
      if (alreadyFavorite) {
        ...
        setMessageText("Max number of quotes reached. Please delete a quote to add a new one.")
        setShowMessage(true);
      } 
    };
